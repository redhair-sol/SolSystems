export const strings = {
  el: {
      ...
      whatWeDo: {
        ...
        services: [
          ...
          },
          {
            ...
            description:
              "Custom λύσεις λογισμικού με σύγχρονα frameworks. Από web εφαρμογές μέχρι enterprise συστήματα.",
          },
          {
    ...
    services: {
      ...
      list: [
        ...
        },
        {
          title: "Custom Development",
          description:
            "Λύσεις λογισμικού φτιαγμένες από το μηδέν. Χρησιμοποιούμε σύγχρονα frameworks και best practices για εφαρμογές γρήγορες, ασφαλείς και εύκολες στη συντήρηση.",
          features: ["React & Next.js", "Node.js & Python", "Mobile Apps", "Σχεδιασμός API", "Εκσυγχρονισμός Legacy"],
        },
        {
          title: "Κυβερνοασφάλεια",
          description:
      ...
      cta: {
        ...
        subtitle:
          "Κλείστε ένα δωρεάν discovery call. Θα αξιολογήσουμε την υπάρχουσα δομή σας και θα προτείνουμε τη σωστή προσέγγιση.",
        button: "Κλείστε Discovery Call",
      },
    },
    ...
    about: {
      ...
      values: [
        {
          ...
          description:
            "Μετράμε την επιτυχία με βάση τα επιχειρηματικά αποτελέσματα που παραδίδουμε, όχι τις γραμμές κώδικα που γράφουμε.",
        },
        {
          title: "Καινοτομία στο επίκεντρο",
          description:
            "Παραμένουμε μπροστά από τις τεχνολογικές εξελίξεις, ώστε οι πελάτες μας να μην ανησυχούν ότι μένουν πίσω.",
        },
        {
      ...
      cta: {
        title: "Θέλετε να συνεργαστείτε μαζί μας;",
        subtitle: "Αναζητούμε πάντα φιλόδοξους συνεργάτες με ενδιαφέρουσες προκλήσεις.",
        button: "Επικοινωνία",
      },
    },
    ...
    contact: {
      ...
      intro:
        "Είτε έχετε ξεκάθαρο project brief είτε απλώς ένα πρόβλημα που χρειάζεται λύση, θα θέλαμε να σας ακούσουμε.",
      info: {
        emailLabel: "Email",
